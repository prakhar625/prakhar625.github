...
var aLittleGray = "hsl(0, 90%, 98%)";
var objCol = "hsl(0, 0%, 100%)";
var purple = "hsl(277, 88%, 56%)";
var dPurple = "hsl(277, 88%, 40%)";
var black = "hsl(0 , 0%, 0%)";
var container, stats;
...
function init() {
    ...
    scene.fog = new THREE.Fog( purple, 1, 200 );
    ...
    scene.add( new THREE.AmbientLight( "hsl(277, 88%, 30%)" ) );

    light = new THREE.DirectionalLight( "hsl(0, 100%, 100%)" );
    light.position.set( 0, 1, -1 );
    scene.add( light );

    hLight = new THREE.HemisphereLight(purple, 1);
